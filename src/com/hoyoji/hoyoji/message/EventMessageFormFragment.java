		...
		if (!mMessageEditor.getModel().getFromUserId()
			...
			try {
				...
				if (newPSA != null && newPSA.getState().equals("Accept")) {
					...
					((HyjActivity)EventMessageFormFragment.this.getActivity()).displayProgressDialog(R.string.projectMessageFormFragment_addShare_fetch_exchange, R.string.projectMessageFormFragment_addShare_fetching_exchange);
					if(projectCurrencyId.equalsIgnoreCase(HyjApplication.getInstance().getCurrentUser().getUserData().getActiveCurrencyId())){
						...
						HyjAsyncTaskCallbacks serverCallbacks = new HyjAsyncTaskCallbacks() {
							...
							public void errorCallback(Object object) {
								...
								((HyjActivity)EventMessageFormFragment.this.getActivity()).displayDialog(-1, R.string.projectMessageFormFragment_addShare_cannot_fetch_exchange, R.string.alert_dialog_yes, R.string.alert_dialog_no, -1,  new DialogCallbackListener(){
									@Override
...
//							}
				...
				((HyjActivity) EventMessageFormFragment.this
...
//				newObj.put("main.state", "Accept");
	...
	private void displayError(Object object) {
		((HyjActivity) EventMessageFormFragment.this.getActivity())
				.dismissProgressDialog();
