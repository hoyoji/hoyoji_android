...
public class CurrencyExchangeViewPagerListFragment extends HyjUserFragment implements OnPageChangeListener {
	...
	public Integer useContentView() {
		return R.layout.currency_exchange_listfragment_viewpager;
	}
	...
	public void onInitViewData() {
		...
		mViewPager = (ViewPager) getView().findViewById(R.id.currencyExchangeViewPagerListFragment_pager);
