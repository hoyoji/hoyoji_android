			...
			for (int i = 0; i < count; i++) {
				...
				if(apportion.getFriendUserId() == null) {
					...
					if(api.getState() == ApportionItem.DELETED ){
						...
						// 更新旧项目分摊支出
						ProjectShareAuthorization oldProjectShareAuthorization = mMoneyIncomeContainerEditor.getOldSelfProjectShareAuthorization();
						HyjModelEditor<ProjectShareAuthorization> oldProjectShareAuthorizationEditor = oldProjectShareAuthorization.newModelEditor();
						...
						MoneyAccount debtAccount = MoneyAccount.getDebtAccount(mMoneyIncomeContainerEditor.getModelCopy().getProject().getCurrencyId(), friend);
						if(api.getState() == ApportionItem.NEW){
			                if(debtAccount == null){
			                	MoneyAccount.createDebtAccount(friend, mMoneyIncomeContainerEditor.getModelCopy().getProject().getCurrencyId(), -apportionEditor.getModelCopy().getAmount0()*apportionEditor.getModelCopy().getExchangeRate());
			                }else{
			                	HyjModelEditor<MoneyAccount> debtAccountEditor = debtAccount.newModelEditor();
			                	debtAccountEditor.getModelCopy().setCurrentBalance(debtAccount.getCurrentBalance() - apportionEditor.getModelCopy().getAmount0()*apportionEditor.getModelCopy().getExchangeRate());
			                	debtAccountEditor.save();
			                }
						} else{
							MoneyAccount oldDebtAccount = MoneyAccount.getDebtAccount(mMoneyIncomeContainerEditor.getModel().getProject().getCurrencyId(), friend);
							...
							if(debtAccount == null){
			                	...
			                	MoneyAccount.createDebtAccount(friend, mMoneyIncomeContainerEditor.getModelCopy().getMoneyAccount().getCurrencyId(), -apportionEditor.getModelCopy().getAmount0()*apportionEditor.getModelCopy().getExchangeRate());
			                }else if(debtAccount.getId().equals(oldDebtAccount.getId())){
			                	oldDebtAccountEditor.getModelCopy().setCurrentBalance(oldDebtAccount.getCurrentBalance() + apportionEditor.getModel().getAmount0()*apportionEditor.getModel().getExchangeRate() - apportionEditor.getModelCopy().getAmount0()*apportionEditor.getModelCopy().getExchangeRate());
			                }else{
			                	HyjModelEditor<MoneyAccount> debtAccountEditor = debtAccount.newModelEditor();
			                	oldDebtAccountEditor.getModelCopy().setCurrentBalance(oldDebtAccount.getCurrentBalance() + apportionEditor.getModel().getAmount0()*apportionEditor.getModel().getExchangeRate());
			                	debtAccountEditor.getModelCopy().setCurrentBalance(debtAccount.getCurrentBalance() - apportionEditor.getModelCopy().getAmount0()*apportionEditor.getModelCopy().getExchangeRate());
						...
						if(mMoneyIncomeContainerEditor.getModelCopy().get_mId() == null || 
							...
							// 更新新项目分摊支出
							ProjectShareAuthorization newProjectShareAuthorization = mMoneyIncomeContainerEditor.getNewSelfProjectShareAuthorization();
							HyjModelEditor<ProjectShareAuthorization> newProjectShareAuthorizationEditor = newProjectShareAuthorization.newModelEditor();
							newProjectShareAuthorizationEditor.getModelCopy().setActualTotalBorrow(newProjectShareAuthorizationEditor.getModelCopy().getActualTotalBorrow()  - (apportionEditor.getModel().getAmount0() * mMoneyIncomeContainerEditor.getModel().getExchangeRate()) + (apportionEditor.getModelCopy().getAmount0() * mMoneyIncomeContainerEditor.getModelCopy().getExchangeRate()));
							newProjectShareAuthorizationEditor.save();
						} else {
							ProjectShareAuthorization oldProjectShareAuthorization = mMoneyIncomeContainerEditor.getOldSelfProjectShareAuthorization();
							HyjModelEditor<ProjectShareAuthorization> oldProjectShareAuthorizationEditor = oldProjectShareAuthorization.newModelEditor();
							oldProjectShareAuthorizationEditor.getModelCopy().setActualTotalBorrow(oldProjectShareAuthorizationEditor.getModelCopy().getActualTotalBorrow() - (apportionEditor.getModel().getAmount0() * mMoneyIncomeContainerEditor.getModel().getExchangeRate()));
							oldProjectShareAuthorizationEditor.save();
							
							// 更新新项目分摊支出
							ProjectShareAuthorization newProjectShareAuthorization = mMoneyIncomeContainerEditor.getNewSelfProjectShareAuthorization();
							HyjModelEditor<ProjectShareAuthorization> newProjectShareAuthorizationEditor = newProjectShareAuthorization.newModelEditor();
							newProjectShareAuthorizationEditor.getModelCopy().setActualTotalBorrow(newProjectShareAuthorizationEditor.getModelCopy().getActualTotalBorrow() + (apportionEditor.getModelCopy().getAmount0() * mMoneyIncomeContainerEditor.getModelCopy().getExchangeRate()));
							newProjectShareAuthorizationEditor.save();
						}
					...
					if(api.getState() == ApportionItem.DELETED ){
						...
						if(apportion.getFriendUserId().equals(HyjApplication.getInstance().getCurrentUser().getId())){
							...
							//更新相关好友的借贷账户
							if(!apportion.getFriendUserId().equals(HyjApplication.getInstance().getCurrentUser().getId())){
								MoneyAccount debtAccount = MoneyAccount.getDebtAccount(mMoneyIncomeContainerEditor.getModelCopy().getProject().getCurrencyId(), apportionEditor.getModelCopy().getFriendUserId());
								if(api.getState() == ApportionItem.NEW){
					                if(debtAccount == null){
					                	MoneyAccount.createDebtAccount(apportionEditor.getModelCopy().getFriendUserId(), mMoneyIncomeContainerEditor.getModelCopy().getProject().getCurrencyId(), -apportionEditor.getModelCopy().getAmount0()*apportionEditor.getModelCopy().getExchangeRate());
					                }else{
					                	HyjModelEditor<MoneyAccount> debtAccountEditor = debtAccount.newModelEditor();
					                	debtAccountEditor.getModelCopy().setCurrentBalance(debtAccount.getCurrentBalance() - apportionEditor.getModelCopy().getAmount0()*apportionEditor.getModelCopy().getExchangeRate());
					                	debtAccountEditor.save();
									...
									MoneyAccount oldDebtAccount = MoneyAccount.getDebtAccount(mMoneyIncomeContainerEditor.getModel().getProject().getCurrencyId(), apportionEditor.getModelCopy().getFriendUserId());
									HyjModelEditor<MoneyAccount> oldDebtAccountEditor = oldDebtAccount.newModelEditor();
									if(debtAccount == null){
										oldDebtAccountEditor.getModelCopy().setCurrentBalance(oldDebtAccount.getCurrentBalance() + apportionEditor.getModel().getAmount0()*apportionEditor.getModel().getExchangeRate());
					                	MoneyAccount.createDebtAccount(apportionEditor.getModelCopy().getFriendUserId(), mMoneyIncomeContainerEditor.getModelCopy().getProject().getCurrencyId(), -apportionEditor.getModelCopy().getAmount0()*apportionEditor.getModelCopy().getExchangeRate());
