...
//	private static String week[] = {"周日","周一","周二","周三","周四","周五","周六"};
	...
	public HyjCalendarGridAdapter(Context context, Resources rs){
		...
		currentDay = sys_day;
		getCalendar(Integer.parseInt(sys_year),Integer.parseInt(sys_month));
	}
	
	public HyjCalendarGridAdapter(Context context,Resources rs,int jumpMonth,int jumpYear,int year_c,int month_c,int day_c){
		this(context, rs);
